...
# Set the Elastic version, with a default known functional version of 8.15.0
read -p "Please enter the Elastic version you want to use (default: 8.15.0): " ELASTIC_VERSION
ELASTIC_VERSION=${ELASTIC_VERSION:-8.15.0}
